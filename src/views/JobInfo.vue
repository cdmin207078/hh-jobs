    ...
    <TabPane label="基本信息" name="t1">
      <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
        ...
        <FormItem label="描述" prop="desc">
          <Input v-model="formValidate.desc" type="textarea" :autosize="{minRows: 2,maxRows: 5}" placeholder="描述信息"></Input>
        </FormItem>

        <Divider orientation="left" style="margin-top: 40px;">报警配置</Divider>
